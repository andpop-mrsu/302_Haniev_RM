...
namespace Ruslan\Tests;

use PHPUnit\Framework\TestCase;
use Ruslan\Task06_2\EconomyRoom;
use Ruslan\Task06_2\StandardRoom;
use Ruslan\Task06_2\SuiteRoom;
use Ruslan\Task06_2\InternetDecorator;
use Ruslan\Task06_2\BreakfastDecorator;
use Ruslan\Task06_2\FoodDeliveryDecorator;
use Ruslan\Task06_2\SofaDecorator;
